...
class RangePassRequirement(PassRequirement):
    ...
    def check_passed(self, golden_value, check_value, check_string="golden value"):
        if golden_value == None and check_value == None:
            ...
            return (
                False,
                "{} is None, but check value is {}".format(check_string, check_value),
            )
        elif golden_value != None and check_value == None:
            return (
                False,
                "{} is {}, but check value is None".format(check_string, golden_value),
            )
        ...
        if original_check_value == original_golden_value:
            ...
            if self.min_value() <= norm_check_value <= self.max_value():
                ...
                return (
                    False,
                    "relative value {} outside of range [{},{}] and not equal to {} value: {}".format(
                        norm_check_value,
                        self.min_value(),
                        self.max_value(),
                        check_string,
...
class RangeAbsPassRequirement(PassRequirement):
    ...
    def check_passed(self, golden_value, check_value, check_string="golden value"):
        ...
        if (self.min_value() <= norm_check_value <= self.max_value()) or abs(
            ...
            return (
                False,
                "relative value {} outside of range [{},{}], above absolute threshold {} and not equal to {} value: {}".format(
                    norm_check_value,
                    self.min_value(),
                    self.max_value(),
                    self.abs_threshold(),
