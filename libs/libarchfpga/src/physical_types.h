...
/* Type of interconnect within complex block: Complete for everything connected (full crossbar), direct for one-to-one connections, mux for many-to-one connections, and partial for connections based input pins's fout value (sparse crossbar) */
enum e_interconnect {
    COMPLETE_INTERC = 1,
    DIRECT_INTERC = 2,
    MUX_INTERC = 3,
